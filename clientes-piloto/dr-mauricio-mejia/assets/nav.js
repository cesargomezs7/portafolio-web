...
(function () {
  ...
  var WA = 'https://wa.me/573136124263';
  ...
  var navbar =
    '<nav class="navbar" id="navbar">' +
      ...
      '<a href="index.html" class="nav-logo">Dr. Mauricio Mejía</a>' +
      '<ul class="nav-links">' +
      ...
      '</ul>' +
      '<a href="' + WA + '?text=Hola%20Dr.%20Mauricio%20Mejia,%20quiero%20agendar%20una%20valoración" target="_blank" class="nav-cta">Agendar consulta</a>' +
    '</nav>';
  ...
  var mobile =
    '<div class="mobile-menu" id="mobileMenu">' +
      ...
      '<ul>' +
        ...
        '<li><a class="mm-cta" href="' + WA + '?text=Hola%20Dr.%20Mauricio%20Mejia,%20quiero%20agendar%20una%20valoración" target="_blank">Agendar por WhatsApp</a></li>' +
      '</ul>' +
    '</div>';
