...
(function () {
  ...
  function track(ev) {
    try { fetch(TRACK, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ event: ev, clinica: 'DentiTown' }), keepalive: true }); } catch (e) {}
  }
  track('visit');
  ...
  var base = floatEl.getAttribute('data-wa-base') || 'https://wa.me/573172328959?text=';
