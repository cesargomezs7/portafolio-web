...
(function () {
  ...
  function track(ev) {
    try { fetch(TRACK, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ event: ev, clinica: 'Oral+' }), keepalive: true }); } catch (e) {}
  }
  ...
  var base = floatEl.getAttribute('data-wa-base') || 'https://wa.me/573116179457?text=';
