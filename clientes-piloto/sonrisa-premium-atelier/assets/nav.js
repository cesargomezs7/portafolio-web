/* ───────────────────────────────────────────────
   Módulo Pronto · Navegación compartida (piel ATELIER)
   Inyecta el navbar (con desplegables Servicios/Sedes)
   y el menú móvil en <div id="site-nav"></div>.
   Conserva la estructura Atelier: burger + logo Fraunces +
   links + acciones (teléfono pill + CTA outline).
   ─────────────────────────────────────────────── */
(function () {
  ...
  var navbar =
    '<nav class="navbar" id="navbar">' +
      ...
      '<a href="index.html" class="nav-logo">Sonrisa Atelier</a>' +
      '<ul class="nav-links">' +
      ...
      '<div class="nav-actions">' +
        '<a href="tel:+573124672674" class="nav-phone">+57 312 467 2674</a>' +
