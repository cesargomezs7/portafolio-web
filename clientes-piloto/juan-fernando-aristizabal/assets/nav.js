...
(function () {
  ...
  var WA = 'https://wa.me/573155471464';
      ...
      '<ul class="nav-links">' +
        ...
        '<li class="nav-dd">' +
          ...
          '<ul class="nav-sub">' +
            ...
            '<li><a href="ortodoncia.html">Ortodoncia invisible</a></li>' +
            '<li><a href="diseno-de-sonrisa.html">Diseño de sonrisa</a></li>' +
            '<li><a href="blanqueamiento.html">Blanqueamiento</a></li>' +
            '<li><a href="diseno-de-sonrisa.html">Estética y rehabilitación</a></li>' +
            '<li><a href="odontologia-general.html">Higiene y prevención</a></li>' +
          '</ul>' +
        '</li>' +
        '<li><a href="contacto.html#sedes" data-nav="sedes">Sede Cali</a></li>' +
        '<li><a href="nosotros.html" data-nav="nosotros">Nosotros</a></li>' +
        '<li><a href="contacto.html" data-nav="contacto">Contacto</a></li>' +
      '</ul>' +
      '<a href="' + WA + '?text=Hola%20Aristizábal,%20quiero%20agendar%20una%20valoración" target="_blank" class="nav-cta">Agendar consulta</a>' +
    '</nav>';
  ...
  var mobile =
    '<div class="mobile-menu" id="mobileMenu">' +
      ...
      '<ul>' +
        ...
        '<li><a class="mm-sub" href="ortodoncia.html">Ortodoncia invisible</a></li>' +
        ...
        '<li><a class="mm-sub" href="diseno-de-sonrisa.html">Estética y rehabilitación</a></li>' +
        '<li><a class="mm-sub" href="odontologia-general.html">Higiene y prevención</a></li>' +
        '<li class="mm-group">Sede</li>' +
        '<li><a class="mm-sub" href="contacto.html#sedes">Cali · Holguines Trade Center</a></li>' +
        '<li><a href="nosotros.html">Nosotros</a></li>' +
        '<li><a href="contacto.html">Contacto</a></li>' +
        '<li><a class="mm-cta" href="' + WA + '?text=Hola%20Aristizábal,%20quiero%20agendar%20una%20valoración" target="_blank">Agendar por WhatsApp</a></li>' +
      '</ul>' +
    '</div>';
